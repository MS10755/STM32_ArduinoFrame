...
//#define AIO_SERVER      "mqttadmin.baierinfo.com"
//#define AIO_SERVERPORT  1883
//#define AIO_USERNAME    "xauat"
...
//	gfx.begin();
//	gfx.fillScreen(0x8010);
//	gfx.fillScreen(0xafe5);
...
Adafruit_ILI9481FMC16 tft = Adafruit_ILI9481FMC16();
...
#define ILI9341_GREEN 0x400
#define ILI9341_BLUE 0x867d
...
void setup() {
  ...
  Serial.println(testLines(0x8df1));
  delay(500);
  ...
  Serial.println(testFilledRects(ILI9341_YELLOW, 0x1c9f));
  delay(500);

  Serial.print(F("Circles (filled)         "));
  Serial.println(testFilledCircles(10, 0x1c9f));
