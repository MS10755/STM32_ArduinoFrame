...
#elif defined(ARDUINO_STM32F10x)
#include "utility/WatchdogSTM32F10x.h"
typedef WatchdogSTM32F10x WatchdogType;
#elif defined(ARDUINO_STM32F40x)
#include "utility/WatchdogSTM32F40x.h"
typedef WatchdogSTM32F40x WatchdogType;
#elif defined(LLA_DRIVERS)
#include "utility/WatchdogLLA.h"
typedef WatchdogLLA WatchdogType;
#else
