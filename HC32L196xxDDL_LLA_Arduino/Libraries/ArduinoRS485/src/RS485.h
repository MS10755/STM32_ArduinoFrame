...
typedef enum {CTR_THRL , CTR_TLRH, CTR_NOTUSE}ctr_mode_t;
class RS485Class : public Stream {
  public:
    RS485Class(HardwareSerial& hwSerial, int pin_txrx_ctr =-1 , ctr_mode_t ctr_mode = CTR_NOTUSE);
